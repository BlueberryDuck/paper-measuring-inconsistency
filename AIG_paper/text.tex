...
In this paper arbitrary and non-monotonic frameworks are to be discussed, which is why an abstract definition of logic will be given, based on \cite{brewka_strong_2019}.

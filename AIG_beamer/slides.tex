...
\begin{frame}{Inconsistency Measures}
    \begin{block}{Definition}
        \begin{itemize}
            \item An \darkhighlight{inconsistency measure} is a function $\mathcal{I}$ applied to a knowledge base $\mathcal{K}$.
    ...
    \begin{block}{Logic Programming}
        \begin{itemize}
            ...
            \item Logic programs contain disjunctions and two kinds of negation:
                  \begin{itemize}
                      \item \darkhighlight{Strong negation} ($\neg$)
                      \item \darkhighlight{Default negation} (\texttt{not})
                  \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Syntax of Logic Programs}
    \begin{block}{Rule Structure}
        ...
        \begin{itemize}
            ...
            \item \darkhighlight{Negative body}: $neg(r) = \{l_{m+1}, \dots, l_n\}$
        \end{itemize}
    \end{block}
\end{frame}
